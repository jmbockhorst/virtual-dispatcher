...
public class AvailabilityHandler extends TextWebSocketHandler {
    ...
    public void fetch() throws IOException {
        List<Availability> availabilities = availabilityDAO.list();
        String newData = objectMapper.writeValueAsString(availabilities);
