    ...
    return {
        ...
        AtmosphereRequest: function AtmosphereRequest(options) {
            ...
            function _invokeCallback() {
                ...
                var messages = isString && _request.trackMessageLength ? _response.responseBody.split(_request.messageDelimiter) : new Array(_response.responseBody);
        ...
        subscribe: function subscribe(url, callback, request) {
        ...
        _closeUrl: function _closeUrl(rq) {
        ...
        unsubscribeUrl: function unsubscribeUrl(url) {
            var idx = -1;
            if (jQuery.atmosphere.requests.length > 0) {
        ...
        publish: function publish(request) {
